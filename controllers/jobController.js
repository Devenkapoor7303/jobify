...
export const deleteJob = async (req, res) => {
  ...
  if (!removeJob) throw new NotFoundError("No Job found with id");
  res.status(StatusCodes.OK).json({ msg: "Job has been Deleted", removeJob });
};
...
export const updateJob = async (req, res) => {
  ...
  if (!updatedJob) throw new NotFoundError("No Job found with id");
